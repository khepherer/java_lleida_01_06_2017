...
public class Main {
    ...
    void initSpring() {
        ...
        ejemploServicio = (EjemploServicio) ctx.getBean(EjemploServicio.class);
    ...
    void testTodosLosClientes() {
        ...
        for (Cliente c : ejemploServicio.getClientes()) {
            System.out.println(c);
            System.out.println("Este cliente tiene " + c.getCuentas().size() + " cuentas");
